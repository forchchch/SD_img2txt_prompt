...
export OUTPUT_DIR="./output_dreambooth/our_versions/backpack"
...
CUDA_VISIBLE_DEVICES=1 accelerate launch dreambooth_scenario.py \
  ...
  --special_token="backpack</w>" \
  --reference_folder_name="backpack" \
  --resolution=512 \
  --train_batch_size=1 \
  ...
  --disen=0.0 \
  # --img_adapt \
  # --with_scenario --scenario_weight=0.1 \
